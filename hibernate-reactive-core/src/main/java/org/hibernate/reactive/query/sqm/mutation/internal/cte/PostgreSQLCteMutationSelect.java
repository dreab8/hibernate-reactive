 ...
 */
public class PostgreSQLCteMutationSelect implements JdbcSelect {
	...
	private static void addExplicitCastToParameters(
		...
		jdbcParameterBindings.visitBindings(
				(jdbcParameter, jdbcParameterBinding) ->
						addExplicitCastToParameter( newSelect, typeConfiguration, jdbcParameter, jdbcParameterBinding )
		);
	}
